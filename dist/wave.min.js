...
;(reportPageMessaging.fn.setupAndDispatchEvent = function (e, t) {
  var a = new CustomEvent(e, { detail: { data: t } })
    ...
    document.addEventListener('setExtensionUrl', function (e) {
      ...
      document.addEventListener('contrastIconDetails', function (e) {
        if (wave.tabsengine.currentContrastIcon) {
          var t = reportPageMessaging.fn.getMessageData(
              e.detail
            ).foregroundColor,
            a = reportPageMessaging.fn.getMessageData(e.detail).backgroundColor
      ...
      document.addEventListener('iconClickAction', function (e) {
        var t = wave.report.things.iconsByType(
  ...
  (wave.fn.resizeReportWindow = function () {
    if ('extension' != waveconfig.platform) {
      var e =
        window.innerHeight -
  ...
  (wave.fn.initialize = function () {
    var e = waveconfig.extensionUrl.substring(
      0,
  ...
  (wave.fn.showThings = function () {
    var e = wave.report.iconlist,
      t = wave.engine.icons.docs
  ...
  (wave.fn.insertIconBoxForChromeExtension = function () {
    if (!waveconfig.isSidebar) {
      ...
      var n = document.createTextNode('Icon Title')
      a.appendChild(n)
  ...
  (wave.manager.ThingManager = function (e, t, a) {
    for (var n in ((this.contextPage = a),
    ...
    e))
      if (((wave.engine.icons.stats[n] = e[n].count), e[n].count > 0))
        for (var i in e[n].items)
          for (var s = e[n].items[i], o = 0; o < s.xpaths.length; o++) {
            var r = s.xpaths[o]
            ...
            this.attach(l),
              ...
              -1 == this._typesByGroup[n].indexOf(s.id) &&
  ...
  (wave.manager.ThingManager.prototype.attach = function (e) {
    ...
    switch (e.position) {
      ...
      case 'first':
        if (
          e.target.nodeName &&
          -1 !== e.target.nodeName.search(/(INPUT|IMG|SVG|TEXTAREA|SELECT)$/i)
        ) {
          t = e.target.insertAdjacentElement('beforebegin', e.iconElement)
          break
        }
  ...
  (wave.manager.ThingManager.prototype.showAll = function () {
    for (var e = 0; e < this.iconList.length; e++) this.iconList[e].show()
    ...
    for (var a in this._iconsByType)
  ...
  (wave.manager.ThingManager.prototype.hideAll = function () {
    for (var e = 0; e < this.iconList.length; e++) this.iconList[e].hide()
    this.updateTopbar()
  }),
  (wave.manager.ThingManager.prototype.showType = function (e) {
    for (var t = this.iconsByType(e), a = 0; a < t.length; a++) t[a].show()
    this.updateTopbar()
  }),
  (wave.manager.ThingManager.prototype.hideType = function (e) {
    for (var t = this.iconsByType(e), a = 0; a < t.length; a++) t[a].hide()
    this.updateTopbar()
  }),
  (wave.manager.ThingManager.prototype.showGroup = function (e) {
    var t = this.iconsByGroup(e)
    if (t) {
      for (var a = 0; a < t.length; a++) t[a].show()
      this.updateTopbar()
    }
  }),
  ...
  (wave.manager.ThingManager.prototype.updateTopbar = function () {
    ...
    if (
      ...
      if (
        ...
        null == document.getElementById('pagewide_txt'))
      ) {
  ...
  (wave.manager.Icon.prototype.create = function (e) {
    ...
    if (this.hasText) {
      ...
      var n = document.createTextNode('*' + this.iconText + '*')
    ...
    ;(this.iconElement.style.animationPlayState = 'running'),
      ...
      (this.iconElement.onanimationend = function (t) {
        ;(t.target.style.animationPlayState = 'paused'),
          ...
          'extension' != waveconfig.platform && e.remove()
      })
  }),
  (wave.manager.IconBox = function () {
    ...
    for (var t = wave.report.things.icons(), a = 0; a < t.length; a++)
      t[a].iconElement.addEventListener(
        ...
        t[a].iconElement.addEventListener(
          ...
          (function (e) {
            return function (t) {
              ;(13 != t.keyCode && 32 != t.keyCode) || iconClick(e)
            }
          })(t[a])
        ),
        (iconClick = function (e) {
          if (
            (1 == wave.tabsengine.codePanelOpen &&
              '#' !== e.itemXPath &&
              wave.code.setSelected(e),
            'contrast' == e.data.name || 'contrast' == e.type)
          )
            if (
              ((wave.tabsengine.currentContrastIcon = e),
              'extension' == waveconfig.platform)
            ) {
              var t = e.iconContrastdata,
                a = (t[0], t[1].substring(1)),
                n = t[2].substring(1),
                i = t[3]
              reportPageMessaging.fn.setupAndDispatchEvent(
          ...
          'tab-reference' == wave.tabs.current &&
            ('extension' == waveconfig.platform
              ? reportPageMessaging.fn.setupAndDispatchEvent(
                  'moreInfo',
                  e.data.name
          ...
          var s = document.getElementById('wave5_iconbox_doclink')
          s.textContent = ''
          var o = document.createElement('a')
          o.href = '#'
          var r,
            l = document.createTextNode('Reference')
          o.appendChild(l),
            s.append(o),
            o.addEventListener(
              'click',
          ...
          var d = document.getElementById('wave5_iconbox')
          ...
          var u,
            ...
            p = wave.page.body.offsetWidth
          u =
            'wave5topbar' == e.target.id || 'extension' == waveconfig.platform
              ? 0
              : document.getElementById('sidebar_container').offsetWidth
          var h = e.iconElement.getBoundingClientRect().left,
            b = e.iconElement.getBoundingClientRect().top,
            v =
              'extension' == waveconfig.platform || 'wave5topbar' == e.target.id
                ? 0
  ...
  Array.prototype.indexOf ||
    (Array.prototype.indexOf = function (e) {
      ...
      if (
        ...
        return -1
      for (var i = n >= 0 ? n : Math.max(a - Math.abs(n), 0); i < a; i++)
...
if (
  ((FrmInj.func.createSidebar = function () {
    var e = getComputedStyle(FrmInj.vars.html).marginLeft
    ;(e =
      'auto' === e
        ? 0
  ...
  (FrmInj.func.createBottomBar = function () {
    var e = getComputedStyle(FrmInj.vars.html).bottom
    ;(e =
      'auto' === e ? 0 : parseFloat(getComputedStyle(FrmInj.vars.html).bottom)),
  ...
  (wave.xpath.convertIconListToXPathOutput = function (e) {
    var t = {}
    for (var a in e)
      for (var n in (t[a] || (t[a] = {}), e[a]))
        '0' != n && (t[a][this.XPath[n]] = e[a][n])
  ...
  (wave.xpath.getXPathByElement = function (e) {
    ...
    for (var t = ''; e && 1 == e.nodeType; e = e.parentNode)
      if (1 == e.parentNode.nodeType) {
        var a = [].filter.call(e.parentNode.children, function (t) {
          if ('wave5icon' != t.className) return t.tagName == e.tagName
        })
  ...
  (wave.xpath.calculateXPath = function (e) {
    ...
    for (var t = {}, a = 0; e.children && a < e.children.length; a++)
      null == t[e.children[a].nodeName] && (t[e.children[a].nodeName] = 0),
  ...
  (wave.xpath.calculateXPathPrivate = function (e, t) {
    if (e) {
      ...
      for (var a = {}, n = 0; e.childNodes && n < e.childNodes.length; n++)
        1 == e.childNodes[n].nodeType &&
          (null == a[e.childNodes[n].nodeName] &&
  ...
  (wave.Code = function () {
    var e = document.getElementById('wave5code')
    e && e.remove(),
      (this.xpaths = {}),
      (this.htmlRoot = null),
  ...
  (wave.Code.prototype.setSelected = function (e) {
    ;(wave.manager.selectedIcon = e),
      ...
      this.unhighlight()
    var t = document.querySelector('[data-reportxpath="' + e.itemXPath + '"]')
  ...
  (wave.Code.prototype.displayTree = function () {
    var e = document.getElementById('wave5bottombar')
    try {
    ...
    return (
      ...
      (i.onclick = function (t) {
        if (
          ...
          'extension' == waveconfig.platform && 'contrast' === e.data.cat_code)
        ) {
          wave.tabsengine.currentContrastIcon = e
          var a = e.iconContrastdata,
            n = (a[0], a[1]),
            i = a[2],
            s = a[3]
          reportPageMessaging.fn.setupAndDispatchEvent(
          ...
          'contrast' === e.data.cat_code && showContrasts(e.iconContrastdata)
      }),
      i
    )
  }),
  (wave.Code.prototype.iconClickAction = function (e) {
    e.scrollToIcon(),
      wave.iconbox.hide(),
      1 == wave.tabsengine.codePanelOpen && wave.code.setSelected(e),
      'contrast' === e.data.cat_code &&
        (wave.tabsengine.currentContrastIcon = e)
  }),
    ...
    if (
      ...
      (null == e.classList ||
        !(
          ...
          'waveordercontainer' == e.getAttribute('id') ||
          'wave5bottombar' == e.getAttribute('id') ||
          'wave5_iconbox' == e.getAttribute('id') ||
          'wave5topbar' == e.getAttribute('id') ||
          'wave_sidebar_container' == e.getAttribute('id') ||
          'wavescript' == e.getAttribute('id') ||
          'wavestyle' == e.getAttribute('id')
        ))
    ) {
      if (1 === e.nodeType || 9 === e.nodeType || 10 === e.nodeType) {
        var a = wave.xpath.getXPathByElement(e)
        if (void 0 !== wave.report.things.iconBaseXpaths[a]) {
          ...
          for (
            ...
            var s = wave.report.things.iconBaseXpaths[a][i]
            void 0 !== s.data &&
        ...
        for (var r = 0; e.attributes && r < e.attributes.length; r++)
          if (-1 == e.attributes[r].nodeName.indexOf('data-waveid')) {
            var l =
              'wave5style' == e.attributes[r].nodeName
                ? 'style'
                : e.attributes[r].nodeName
            if (('style' == l && '' != e.attributes[r].value) || 'style' != l) {
        ...
        return (
          ...
          -1 ==
            [
              ...
              'track',
              'wbr'
            ].indexOf(e.nodeName.toLowerCase())
  ...
  (wave.engine.fn.override = function (e, t) {
    ...
    for (var a = 0; a < t.length; a++) wave.engine.overrides[e][t[a]] = !0
  }),
  (wave.engine.fn.overrideby = function (e, t) {
    wave.engine.overriddenby[e] || (wave.engine.overriddenby[e] = {})
    for (var a = 0; a < t.length; a++) wave.engine.overriddenby[e][t[a]] = !0
  }),
        ...
        : e
            ...
            .forEach(function (n, i) {
              if (
                ...
                o && -1 == o.search(/^\s+$/i) && (t = !0)
                var r = n.getAttribute('aria-label')
                r && -1 == r.search(/^\s+$/i) && (t = !0)
                var l = n.getAttribute('aria-labelledby')
                l && -1 == l.search(/^\s+$/i) && (t = !0)
              }
              0 == a &&
              'hidden' !== getComputedStyle(e).getPropertyValue('visibility') &&
              'hidden' == getComputedStyle(n).getPropertyValue('visibility')
                ? (t = !1)
                : (a = !0)
            }),
      t
  ...
  (wave.engine.fn.isLabeledByTag = function (e, t) {
    var a = !1,
      n = e.id,
      i = e.closest('label'),
      s = t.querySelectorAll('label[for="' + n + '"]')
    if (s.length > 0)
      (a = !0),
        s.forEach(function (t, n) {
          1 == wave.engine.fn.isElementHidden(t) &&
  ...
  (wave.engine.fn.getPath = function (e) {
    ...
    for (var t = []; e.nodeType === Node.ELEMENT_NODE; ) {
      ...
      if (e.id) a += '#' + e.id
        ...
        for (
          var n = e, i = [];
          null !== n && n.nodeType === Node.ELEMENT_NODE;

        )
          i.unshift(n.nodeName), (n = wave.engine.fn.previousElementSibling(n))
        'HTML' !== i[0] && (i[0] = i[0] + ':first-child'), (a = i.join(' + '))
      }
  ...
  (wave.engine.fn.addIcon = function (e, t, a) {
    a || (a = !1)
    var n = '#' == e ? 0 : e.getAttribute('data-waveid'),
      i = wave.engine.icons.docs[t],
      s = 0 === n ? '#' : wave.xpath.XPath[n],
      o = wave.engine.fn.getPath(e)
    if (i) {
      ...
      if (
        ...
        null == wave.engine.iconList[t].items[s])
      ) {
        var l =
          '#' !== s &&
          (0 == e.offsetWidth ||
  ...
  (wave.engine.fn.structureOutput = function () {
    for (var e in wave.engine.iconList) {
      ...
      for (var a in wave.engine.iconList[e].items) {
        var n = t.cat_code
        wave.engine.statistics.allitemcount ||
          ...
          wave.engine.results[n].items[e]
            ? (wave.engine.results[n].items[e].count++,
              ...
              'contrast' === wave.engine.results[n].items[e].id &&
  ...
  (wave.engine.fn.elementHasText = function (e) {
    var t = !1
    if (!e) return !1
    for (var a = e.childNodes, n = 0; n < a.length; n++)
      if (
        3 == a[n].nodeType &&
        a[n].nodeValue.length > 0 &&
        -1 == a[n].nodeValue.search(/^\s+$/i)
      ) {
        t = !0
        break
      }
  ...
  (wave.engine.fn.calculateContrast = function (e, t, a) {
    if (!e) {
      ...
      if ('0' == (a = this.getColor(e, 'bg'))[3])
        '0' == (a = this.getColor(wave.page.querySelector('html'), 'bg'))[3] &&
          (a = ['255', '255', '255', '1'])
    ...
    for (var n = 0; e.children && n < e.children.length; n++) {
      var i = e.children[n]
      if (
        'wave5bottombar' !== i.getAttribute('id') &&
        'SVG' !== i.tagName.toUpperCase() &&
        'SCRIPT' !== i.tagName &&
        'IMG' !== i.tagName &&
        'STYLE' !== i.tagName &&
        'NOSCRIPT' !== i.tagName.toUpperCase() &&
        'VIDEO' !== i.tagName.toUpperCase() &&
        'AUDIO' !== i.tagName.toUpperCase() &&
        'OPTION' !== i.tagName.toUpperCase() &&
        1 != i.disabled &&
        !0 !== i.hidden &&
        'none' !== getComputedStyle(i).getPropertyValue('display') &&
        'hidden' !== getComputedStyle(i).getPropertyValue('visibility') &&
        '0px' !== getComputedStyle(i).getPropertyValue('font-size') &&
        'true' !== i.ariaDisabled
      )
        if (wave.engine.contrast[i.getAttribute('data-waveid')])
          i.childNodes && wave.engine.fn.calculateContrast(i, t, a)
        else {
          var s = this.getColor(i, 'fg'),
            o = this.getColor(i, 'bg')
          '0' == o[3] && (o = a),
  ...
  (wave.engine.fn.getColor = function (e, t) {
    ...
    if (
      ...
      ('none' != n.filter && 'blur(0px)' != n.filter)
    )
      return !1
    if ('fg' == t)
  ...
  (wave.engine.fn.checkContrast = function (e, t, a) {
    if (!1 !== t && !1 !== a) {
      ...
      n < 1
        ...
        : (fgcolor = t)
      var i = wave.engine.fn.getLuminance(fgcolor) + 0.05,
        s = wave.engine.fn.getLuminance(a) + 0.05,
        o = i / s
      if ((s > i && (o = 1 / o), o)) {
        var r = !1,
          l = !1,
          c =
            (72 *
              parseFloat(getComputedStyle(e).getPropertyValue('font-size'))) /
            96
        if (
          (o < 4.5 &&
            ((r = !0),
            (c >= 18 ||
              (c >= 14 && 'bold' === e.style.fontWeight) ||
              (c >= 14 &&
                getComputedStyle(e).getPropertyValue('font-weight') >= 700)) &&
              ((r = o < 3), (l = !0))),
          r)
        ) {
          var d = wave.engine.fn.waveRGBToHex(t),
            u = wave.engine.fn.waveRGBToHex(a),
            g = [wave.engine.fn.Dec2(Number(o)), d, u, l]
...
;(wave.rules = {}),
  (wave.rules.alt_missing = function (e) {
    wave.engine.fn.overrideby('alt_missing', [
      ...
      e.querySelectorAll('img:not([alt])').forEach(function (e, t) {
        ;(null != e.getAttribute('title') &&
          0 !== e.getAttribute('title').length) ||
          (null != e.getAttribute('aria-label') &&
            0 !== e.getAttribute('aria-label').length) ||
          (null != e.getAttribute('aria-labelledby') &&
            0 !== e.getAttribute('aria-labelledby').length) ||
  ...
  (wave.rules.alt_link_missing = function (e) {
    wave.engine.fn.override('alt_link_missing', [
      ...
      e.querySelectorAll('a').forEach(function (e, t) {
        'wave5codetoggle' != e.parentNode.id &&
          'none' != getComputedStyle(e).getPropertyValue('display') &&
  ...
  (wave.rules.alt_area_missing = function (e) {
    e.querySelectorAll('area').forEach(function (t, a) {
      ...
      if (!n || -1 !== n.search(/^ *$/)) {
        var i = t.closest('map').getAttribute('name')
    ...
    wave.engine.fn.override('longdesc_invalid', ['longdesc']),
      e.querySelectorAll('[longdesc]').forEach(function (e, t) {
        var a = new RegExp('(([a-zA-Z0-9]|\\|/))+'),
          n = new RegExp('(.html|.htm)$'),
          i = new RegExp('(.jpg|.gif|.png)$'),
          s = e.getAttribute('longdesc')
        a.test(s) &&
          (0 == s.length ||
            i.test(s) ||
            (-1 != s.indexOf(' ') && !n.test(s))) &&
    ...
    wave.engine.fn.override('label_empty', ['label', 'label_orphaned']),
      e.querySelectorAll('label').forEach(function (t, a) {
        ...
        ;(!wave.engine.fn.hasTextContent(t) ||
          (((n.length > 0 && wave.engine.fn.isLabeled(n[0], e)) || null != i) &&
            !wave.engine.fn.hasTextContent(t))) &&
  ...
  (wave.rules.label_multiple = function (e) {
    e.querySelectorAll(
      ...
      var n = t.getAttribute('id'),
        i = t.closest('label'),
        s = null != i ? i.length : 0,
        o = null != n ? e.querySelectorAll("label[for='" + n + "']") : null
      o &&
        (o.length > 1 || (1 == s && 1 == o.length && i[0] !== o[0])) &&
        wave.engine.fn.addIcon(t, 'label_multiple')
    })
  }),
  (wave.rules.title_invalid = function (e) {
    var t = e.querySelector('title')
    if (null == t) return wave.engine.fn.addPagewideIcon('title_invalid')
    'svg' != t.parentNode.nodeName &&
      ((null != t.textContent &&
        0 !== t.length &&
        0 !== t.textContent.length &&
        -1 === t.textContent.search(/(^ +$)|(^untitled.*$)/i)) ||
  ...
  (wave.rules.language_missing = function (e) {
    ...
    e.querySelectorAll('html:not([lang])').forEach(function (e, t) {
      ...
      e.querySelectorAll('[lang]').forEach(function (e, n) {
        var i = !1,
          s = e.getAttribute('lang').toLowerCase()
        if (s.indexOf('-') > -1) {
          var o = s.split('-')[0]
          t.includes(o) || (i = !0)
          var r = s.split('-')[1]
  ...
  (wave.rules.link_skip_broken = function (e) {
    ...
    e.querySelectorAll("a[href^='#']").forEach(function (t, a) {
      ...
      if ('#' === i) return !1
      if (-1 !== t.textContent.trim().search(/^(skip|jump).*/gi)) {
        if (
          'none' == getComputedStyle(t).getPropertyValue('display') ||
          'hidden' == getComputedStyle(t).getPropertyValue('visibility')
        )
          n = !0
        else {
          var s = i.replace('#', '')
          0 === e.querySelectorAll('[id="' + s + '"]').length &&
            0 === e.querySelectorAll('a[name="' + s + '"]').length &&
            (n = !0)
        }
    ...
    e
      ...
      .forEach(function (e, t) {
        var a = e.getAttribute('style'),
          n = new RegExp('s*text-decorations*:s*blinks*')
  ...
  (wave.rules.contrast = function (e) {
    for (var t in (wave.engine.fn.calculateContrast(), wave.engine.contrast))
      ...
      e.querySelectorAll("img:not([alt=''])[alt]").forEach(function (e, t) {
        ...
        if (
          ...
          ;(n = n.substring(
            ...
            (-1 == n.indexOf(a.toLowerCase()) &&
              -1 == s.indexOf(a.toLowerCase())) ||
  ...
  (wave.rules.alt_duplicate = function (e) {
    ...
    for (
      var t = e.querySelectorAll("img, input[type='image']"), a = 0;
      a < t.length;
      a++
    )
      if (
        ...
        for (var n = a + 1; n <= a + 2 && n < t.length; n++)
          if (
  ...
  (wave.rules.image_title = function (e) {
    e.querySelectorAll("img[title]:not([title=''])").forEach(function (e, t) {
      if (!e.getAttribute('alt') || 0 == e.getAttribute('alt').length) {
  ...
  (wave.rules.fieldset_missing = function (e) {
    ...
    for (var a in (e
      ...
      .forEach(function (e, a) {
        ...
        if (!n || 20 == e.compareDocumentPosition(n)) {
          var i = e.closest('[role=radiogroup]')
          if (!i || 20 == e.compareDocumentPosition(i)) {
            var s = e.getAttribute('name')
            null == t[s] && (t[s] = []), t[s].length < 2 && t[s].push(e)
          }
        }
      }),
    t))
      if (2 == t[a].length) {
        var n = t[a][0].getAttribute('id'),
          i = t[a][0].closest('label')
        if (i && i.length > 0)
          wave.engine.fn.addIcon(i.get(0), 'fieldset_missing')
        else if (n) {
          var s = e.querySelectorAll("label[for='" + n + "']")
  ...
  (wave.rules.legend_missing = function (e) {
    wave.engine.fn.override('legend_missing', ['fieldset']),
      e.querySelectorAll('fieldset').forEach(function (e, t) {
        0 === e.querySelectorAll('legend').length &&
  ...
  (wave.rules.heading_missing = function (e) {
    wave.engine.fn.override('heading_missing', ['h1_missing']),
      0 === e.querySelectorAll('h1, h2, h3, h4, h5, h6').length &&
  ...
  (wave.rules.heading_skipped = function (e) {
    ...
    e.querySelectorAll('h1, h2, h3, h4, h5, h6').forEach(function (e, n) {
      ;(a = Number(e.nodeName[1])),
        0 != t && t - a < -1 && wave.engine.fn.addIcon(e, 'heading_skipped'),
        (t = a)
    })
  }),
  (wave.rules.heading_possible = function (e) {
    e.querySelectorAll('p').forEach(function (e, t) {
      var a = parseInt(getComputedStyle(e).getPropertyValue('font-size'), 10)
      e.textContent.length > 0 &&
        e.textContent.length < 50 &&
        (a > 20 ||
          (a > 16 &&
            (getComputedStyle(e).getPropertyValue('font-weight') >= 700 ||
              'bold' == e.style.fontWeight ||
              'italic' ==
  ...
  (wave.rules.table_caption_possible = function (e) {
    e.querySelectorAll('table').forEach(function (e, t) {
      if (
        ...
        0 == e.querySelectorAll('caption').length
      ) {
        var a = e.previousElementSibling,
          n = e.querySelectorAll('td')
        if (n.length > 0) {
          var i = n[0].getAttribute('colspan')
          i && i >= 3
  ...
  (wave.rules.list_possible = function (e) {
    ...
    e.querySelectorAll('p').forEach(function (e, a) {
      var n = e.textContent.trim().substr(0, 2)
      if (
        n != t &&
        ((t = n), 0 == n.search(/^(\*\s|\-\s|\-|1\.|a\.|1\)|a\))/))
      ) {
        0 ==
        ...
        var i = e.innerHTML.split(/<br\s*.*?\/?>[\n\r]*\s*/gi, 2)
        i[1] &&
          0 == i[1].trim().search(/^(\*\s|\-\s|\-|2\.|b\.|2\)|b\))/) &&
          wave.engine.fn.addIcon(e, 'list_possible')
      }
    })
  }),
    ...
    wave.engine.fn.overrideby('link_internal_broken', ['link_skip_broken']),
      e
        ...
        .forEach(function (t, a) {
          ...
          n[0] &&
            '#' != n &&
            0 === e.querySelectorAll('[id="' + i + '"]').length &&
            0 === e.querySelectorAll('a[name="' + i + '"]').length &&
  ...
  (wave.rules.link_powerpoint = function (e) {
    e.querySelectorAll('a[href]').forEach(function (e, t) {
      var a = e.getAttribute('href')
      a &&
        -1 !== a.search(/(\.ppt|\.pptx|\.pps|\.ppsx)$/i) &&
  ...
  (wave.rules.link_pdf = function (e) {
    e.querySelectorAll('a[href]').forEach(function (e, t) {
      var a = e.getAttribute('href')
      a && -1 !== a.search(/(\.pdf)$/i) && wave.engine.fn.addIcon(e, 'link_pdf')
    })
  }),
  ...
  (wave.rules.event_handler = function (e) {
    e.querySelectorAll('[onmouseover],[onclick],[ondblclick]').forEach(
      function (e, t) {
        var a = e.getAttribute('onmouseover'),
          n = e.getAttribute('onfocus'),
          i = e.getAttribute('onclick'),
          s = e.getAttribute('ondblclick'),
        ...
        ;(a && !n) || s
          ...
          : i &&
            ...
            'option' !== o &&
            'textarea' !== o &&
            ((r && '0' === r) || wave.engine.fn.addIcon(e, 'event_handler'))
      }
    )
  }),
  ...
  (wave.rules.text_justified = function (e) {
    e.querySelectorAll('p, div, td').forEach(function (e, t) {
      'justify' == getComputedStyle(e).getPropertyValue('text-align') &&
  ...
  (wave.rules.underline = function (e) {
    e.querySelectorAll('p, span, div, td, th, dd, li, u').forEach(
      function (e, t) {
        'U' == e.nodeName && 'A' != e.parentNode.nodeName
  ...
  (wave.rules.fieldset = function (e) {
    wave.engine.fn.overrideby('fieldset', ['legend_missing']),
      e.querySelectorAll('fieldset').forEach(function (e, t) {
        var a = e.querySelector('legend')
        wave.engine.fn.addIcon(null != a ? a : e, 'fieldset')
      })
  }),
  (wave.rules.link_skip = function (e) {
    wave.engine.fn.overrideby('link_skip', ['link_skip_broken']),
      e.querySelectorAll('a[href]').forEach(function (t, a) {
        var n = t.getAttribute('href')
        if (n && 0 != n.length && '#' == n[0] && '#' != n) {
          var i = n.replace('#', '')
          ;-1 !== t.textContent.trim().search(/^(skip|jump).*/gi) &&
            n &&
    ...
    e.querySelectorAll('table').forEach(function (e, t) {
      ...
      if (
        (e.querySelectorAll('th').forEach(function (t, n) {
          var i = t.closest('table')
          20 != e.compareDocumentPosition(i) && (a = !0)
        }),
        0 == a)
      ) {
  ...
  (wave.rules.table_data = function (e) {
    e.querySelectorAll('table').forEach(function (e, t) {
      ...
      e.querySelectorAll('th').forEach(function (t, n) {
        ...
        1 == a && wave.engine.fn.addIcon(e, 'table_data')
    })
  }),
    ...
    wave.engine.fn.override('region', ['region_missing']),
      e
        ...
        .forEach(function (e, t) {
          ...
          ;(null == a && null == n) || wave.engine.fn.addIcon(e, 'region')
        })
  }),
    ...
    e
      ...
      e.querySelectorAll("a[href*='youtube.com']").forEach(function (e, t) {
        var a = e
          ...
          n = void 0 !== a[2] ? a[2].split(/[^0-9a-z_\-]/i)[0] : a[0]
        n.includes('youtube') ||
          n.includes('user') ||
          wave.engine.fn.addIcon(e, 'youtube_video')
      })
  ...
  (wave.rules.aria = function (e) {
    ...
    e.querySelectorAll('*:not(#wave5bottombar)').forEach(function (e, n) {
      for (var i = '', s = 0; s < e.attributes.length; s++)
        (-1 !== e.attributes[s].name.search(/^aria-/i) ||
          e.getAttribute('role')) &&
          ((-1 !== e.attributes[s].name.search(/^aria-/i) &&
            t.indexOf(e.attributes[s].name) < 0) ||
            ('role' == e.attributes[s].name &&
      ...
      e
        ...
        .forEach(function (e, t) {
          for (var a = 0, n = 0; n < e.attributes.length; n++)
            if (-1 !== e.attributes[n].name.search(/^aria-label/i)) {
              var i = e.attributes[n].name + '="' + e.attributes[n].value + '"'
              wave.engine.fn.addIcon(e, 'aria_label', i), a++
            }
          0 == a && wave.engine.fn.addIcon(e, 'aria_label')
        })
  }),
  (wave.rules.aria_describedby = function (e) {
    e.querySelectorAll('[aria-describedby]').forEach(function (e, t) {
      for (var a = 0, n = 0; n < e.attributes.length; n++)
        if (-1 !== e.attributes[n].name.search(/^aria-describedby/i)) {
          var i = e.attributes[n].name + '="' + e.attributes[n].value + '"'
          wave.engine.fn.addIcon(e, 'aria_describedby', i), a++
        }
      0 == a && wave.engine.fn.addIcon(e, 'aria_describedby')
    })
  }),
      ...
      function (a, n) {
        ...
        if (null != i && '' != i) {
          ...
          for (var s = 0; s < i.length; s++)
            if (0 === e.querySelectorAll('[id="' + i[s] + '"]').length) {
              t = !0
              break
            }
        }
        if (!t) {
          ...
          if (null != o && '' != o) {
            ...
            for (s = 0; s < o.length; s++)
              if (0 === e.querySelectorAll('[id="' + o[s] + '"]').length) {
                t = !0
                break
              }
          }
  ...
  (wave.rules.aria_menu_broken = function (e) {
    e.querySelectorAll(
      ...
      0 ===
        ...
        ).length && wave.engine.fn.addIcon(e, 'aria_menu_broken')
    })
  }),
  ...
  (wave.rules.aria_button = function (e) {
    e.querySelectorAll("[role='button']").forEach(function (e, t) {
      'BUTTON' !== e.nodeName && wave.engine.fn.addIcon(e, 'aria_button')
    })
  }),
  ...
  (wave.tabsengine.buildOutlineHtml = function () {
    var e = '',
      t = ['H1', 'H2', 'H3', 'H4', 'H5', 'H6'],
      a = ['HEADER', 'NAV', 'MAIN', 'ASIDE', 'FOOTER', 'SEARCH'],
      n = [
        'BANNER',
        'SEARCH',
        'NAVIGATION',
    ...
    for (var d in wave.report.things.allTagsCached)
      if (
        wave.report.things.allTagsCached.hasOwnProperty(d) &&
        r.indexOf(d) > -1
      ) {
        var u = wave.report.things.allTagsCached[d],
          g = u.getAttribute('role')
        g = null !== g ? g.toUpperCase() : g
        var m,
          p = u.tagName.toUpperCase(),
          h = {
            HEADER: 'Header',
            NAV: 'Navigation',
            MAIN: 'Main',
        ...
        if (((m = h.hasOwnProperty(p) ? h[p] : i(g)), s.length > 0))
          for (l = 0; l < s.length; l++)
            -1 == d.indexOf(s[l]) && ((e += '</div>'), s.splice(l, 1), l--)
  ...
  (wave.tabsengine.toggleStyles = function (e) {
    ...
    if ((wave.iconbox.hide(), !0 === e)) {
      ...
      for (let e = 0; e < a.length; e++)
        (null == a[e].href ||
          (null != a[e].href &&
            -1 == a[e].href.indexOf('chrome-extension://') &&
            -1 == a[e].href.indexOf('moz-extension://'))) &&
          (a[e].disabled = !0)
      t
        .querySelectorAll(
    ...
    1 == wave.tabsengine.navOrderVisible &&
  ...
  (wave.tabsengine.showNavOrder = function (e, t) {
    if (
      (wave.iconbox.hide(),
      'show' != e || null == t || t == wave.tabsengine.WaveIconsVisible)
    ) {
      var a =
        'extension' == waveconfig.platform
          ? document
          : document.getElementById('report').contentWindow.document
      if ('show' == e) {
        null != a.getElementById('waveordercontainer') &&
          a.getElementById('waveordercontainer').remove(),
          (wave.tabsengine.navOrderVisible = !0)
        var n = wave.tabsengine.buildNavItems(a)
        'extension' == waveconfig.platform
          ? (waveconfig.debug,
    ...
    ;(t.style.animationPlayState = 'running'),
      ...
      (t.onanimationend = function (e) {
        ;(e.target.style.animationPlayState = 'paused'),
          ...
          'extension' != waveconfig.platform && a.remove()
      })
  }),
  (wave.tabsengine.buildNavItems = function (e) {
    ...
    var i = [],
      ...
      l = 1,
      c =
        'absolute' == getComputedStyle(e.body).getPropertyValue('position')
          ? 380
          : 0
    return (
      t.forEach(function (e) {
        if (
          ...
          u.classList.add('waveorder'),
            ...
            (u.style.top = d + 'px'),
            n.appendChild(u)
          var g = wave.tabsengine.getAccName(e)
  ...
  (wave.tabsengine.getPseudoContent = function (e, t) {
    var a = window.getComputedStyle(e, t),
      n = a.getPropertyValue('content'),
      i = 'inline' === a.display.substr(0, 6)
    return n
      ? '"' !== n.substr(0, 1)
        ? ''
        : i
  ...
  (wave.tabsengine.getAccName = function (e, t, a, n, i) {
    ...
    if (
      ...
      !s.trim() && t && 'OPTION' == e.tagName && (s = e.textContent),
      !s.trim() && !t && e.labels)
    )
      if (e.labels.length > 0) {
        ...
        var r = e.options[e.selectedIndex] || e.querySelector('option')
        s = r
        ...
        s =
          'BUTTON' === e.tagName || ('submit' != e.type && 'reset' != e.type)
    ...
    if (
      ...
      var l = { FIGURE: 'figcaption', TABLE: 'caption', FIELDSET: 'legend' }
      for (var c in l)
        if (e.tagName == c) {
          var d = e.querySelector(l[c])
        ...
        e
          ...
          .forEach(function (e, t) {
            if (
              ...
              var n = e.getAttribute('alt')
              n && -1 == n.search(/^\s+$/i) && (s = n)
              var i = e.getAttribute('title')
              i && -1 == i.search(/^\s+$/i) && (s = i)
              var o = e.getAttribute('aria-label')
              o && -1 == o.search(/^\s+$/i) && (s = o)
    ...
    var g = wave.tabsengine.getPseudoContent(e, ':before'),
      m = wave.tabsengine.getPseudoContent(e, ':after')
    if (t || i) return g + s + m
    var p = e.getAttribute('role')
      ? e.getAttribute('role')
      : e.tagName.toLowerCase()
    return (
      (p = 'input' == (p = 'a' == p ? 'Link' : p) ? e.type + ' ' + p : p) +
      ': ' +
      g +
      s +
      m
